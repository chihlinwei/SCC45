library(raster)
epc <- brick("E:/CIMP5/Raster/epcBottom/epcBottom_Omon_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
o2 <- brick("E:/CIMP5/Raster/o2Bottom/o2Bottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
ph <- brick("E:/CIMP5/Raster/phBottom/phBottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
thetao <- brick("E:/CIMP5/Raster/thetaoBottom/thetaoBottom_Omon_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
arag <- brick("E:/CIMP5/Raster/aragBottom/aragBottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
calc <- brick("E:/CIMP5/Raster/calcBottom/calcBottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
co3 <- brick("E:/CIMP5/Raster/co3Bottom/co3Bottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
co3satarag <- brick("E:/CIMP5/Raster/co3sataragBottom/co3sataragBottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
co3satcalc <- brick("E:/CIMP5/Raster/co3satcalcBottom/co3satcalcBottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
aragsat <- brick("E:/CIMP5/Raster/aragsatBottom/aragsatBottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
calcsat <- brick("E:/CIMP5/Raster/calcsatBottom/calcsatBottom_Oyr_GFDL-ESM2G_IPSL-CM5A-MR_MPI-ESM-MR_rcp45_r1i1p1.grd")
